...
/** \internal Compute index im at which Francis QR advance starts and the first Householder vector. */
template<typename MatrixType>
...
/** \internal Perform a Francis QR advance involving rows il:iu and columns im:iu. */
template<typename MatrixType>
