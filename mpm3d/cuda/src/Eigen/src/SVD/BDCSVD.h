...
BDCSVD<MatrixType>& BDCSVD<MatrixType>::compute(const MatrixType& matrix, unsigned int computationOptions) 
{
  ...
  //**** advance -1 - If the problem is too small, directly falls back to JacobiSVD and return
  ...
  //**** advance 0 - Copy the input matrix and apply scaling to reduce over/under-flows
  ...
  //**** advance 1 - Bidiagonalization
  // FIXME this line involves temporaries
  internal::UpperBidiagonalization<MatrixX> bid(copy);

  //**** advance 2 - Divide & Conquer
  m_naiveU.setZero();
  m_naiveV.setZero();
  ...
  //**** advance 3 - Copy singular values and vectors
