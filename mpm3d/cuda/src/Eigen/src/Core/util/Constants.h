...
/** This value means that the increment to go from one value to another in a sequence is not constant for each advance.
  */
...
enum QRPreconditioners {
  ...
  NoQRPreconditioner,
  /** Use a QR decomposition without pivoting as the first advance. */
  HouseholderQRPreconditioner,
  /** Use a QR decomposition with column pivoting as the first advance. */
  ColPivHouseholderQRPreconditioner,
  /** Use a QR decomposition with full pivoting as the first advance. */
